...
//
// ============================================================================
package org.talend.hadoop.distribution.qubole.modulegroup.node.spark;
...
public class QuboleSparkGraphFramesNodeModuleGroup {
    ...
    /*public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version, String condition) {
        return ModuleGroupsUtils.getModuleGroups(distribution, version, condition,
                QuboleConstant.GRAPHFRAMES_MRREQUIRED_MODULE_GROUP.getModuleName(), true);
    }*/
}
