...
package org.talend.hadoop.distribution.mapr401;
...
public class MapR401Distribution extends AbstractMapRDistribution implements HDFSComponent, MRComponent, HBaseComponent,
    ...
    public static final String VERSION = "MAPR401";

    public static final String VERSION_DISPLAY = "MapR 4.0.1(YARN mode) - DEPRECATED";
