...
public enum EHDFSRepositoryToComponent {
    ...
    USE_WEBHDFS_SSL("USE_WEBHDFS_SSL", "USE_WEBHDFS_SSL"), //$NON-NLS-1$//$NON-NLS-2$

    WEBHDFS_SSL_TRUST_STORE_PATH("WEBHDFS_SSL_TRUST_STORE_PATH", "WEBHDFS_SSL_TRUST_STORE_PATH"), //$NON-NLS-1$//$NON-NLS-2$

    WEBHDFS_SSL_TRUST_STORE_PASSWORD("WEBHDFS_SSL_TRUST_STORE_PASSWORD", "WEBHDFS_SSL_TRUST_STORE_PASSWORD"); //$NON-NLS-1$//$NON-NLS-2$
