...
public class HDP260PigOutputModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false, hcatStorerCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroStorerCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileStorerCondition));
