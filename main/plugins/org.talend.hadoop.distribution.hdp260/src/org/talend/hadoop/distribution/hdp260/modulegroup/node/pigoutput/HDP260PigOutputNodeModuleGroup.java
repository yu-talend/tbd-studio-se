...
//
// ============================================================================
package org.talend.hadoop.distribution.hdp260.modulegroup.node.pigoutput;
...
public class HDP260PigOutputNodeModuleGroup {
    ...
    private static final ComponentCondition condition = new MultiComponentCondition(
            ...
            new LinkedNodeExpression(PigOutputConstant.PIGSTORE_COMPONENT_LINKEDPARAMETER, ComponentType.PIG
                    .getVersionParameter(), EqualityOperator.EQ, HDP260Distribution.VERSION));
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_PARQUET_MODULE_GROUP.getModuleName(), false, condition));
