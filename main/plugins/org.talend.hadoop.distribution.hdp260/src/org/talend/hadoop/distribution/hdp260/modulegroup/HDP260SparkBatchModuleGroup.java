...
public class HDP260SparkBatchModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.SPARK_MODULE_GROUP.getModuleName(), false, condition));
        hs.add(new DistributionModuleGroup(HDP260Constant.SPARK_MRREQUIRED_MODULE_GROUP.getModuleName(), true, condition));
