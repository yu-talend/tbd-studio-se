...
public class HDP260HiveModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(HDP260Constant.HIVE_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
