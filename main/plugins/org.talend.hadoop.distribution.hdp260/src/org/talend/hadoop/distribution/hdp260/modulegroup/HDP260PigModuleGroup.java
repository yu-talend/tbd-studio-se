...
public class HDP260PigModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false, hcatLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_PARQUET_MODULE_GROUP.getModuleName(), false, parquetLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_SEQUENCEFILE_MODULE_GROUP.getModuleName(), false,
                sequencefileLoaderCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.PIG_S3_MODULE_GROUP.getModuleName(), false, s3condition));
        hs.add(new DistributionModuleGroup(HDP260Constant.TEZ_MODULE_GROUP.getModuleName(), true, tezCondition));
        hs.add(new DistributionModuleGroup(HDP260Constant.TEZ_SERVER_MODULE_GROUP.getModuleName(), true, tezServerCondition));
