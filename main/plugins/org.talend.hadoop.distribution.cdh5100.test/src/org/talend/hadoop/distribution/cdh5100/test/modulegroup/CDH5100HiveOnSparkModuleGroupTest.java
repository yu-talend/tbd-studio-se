...
public class CDH580HiveOnSparkModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(CDH580Constant.SPARK_HIVE_MRREQUIRED_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = CDH580HiveOnSparkModuleGroup.getModuleGroups();
