...
//
// ============================================================================
package org.talend.hadoop.distribution.cdh5100.test.modulegroup.node.sparkstreaming;
...
public class CDH5100SparkStreamingParquetNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                CDH5100Constant.SPARK_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(),
        ...
        Set<DistributionModuleGroup> moduleGroups = CDH5100SparkStreamingParquetNodeModuleGroup.getModuleGroups(
