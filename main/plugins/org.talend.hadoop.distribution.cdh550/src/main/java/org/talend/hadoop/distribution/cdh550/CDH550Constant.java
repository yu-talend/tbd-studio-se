...
public enum CDH550Constant {
    ...
    SPARK_AZURE_MRREQUIRED_MODULE_GROUP("SPARK-AZURE-LIB-MRREQUIRED-CDH_5_5"), //$NON-NLS-1$
    ...
    MAPREDUCE_PARQUET_MRREQUIRED_MODULE_GROUP("MAPREDUCE-PARQUET-LIB-MRREQUIRED-CDH_5_5"), //$NON-NLS-1$
    ...
    PIG_S3_MODULE_GROUP("PIG-S3-LIB-CDH_5_5"), //$NON-NLS-1$
    ...
    TALEND_CLOUDERA_CDH_5_5_NAVIGATOR("TALEND_CLOUDERA_CDH_5_5_NAVIGATOR"), //$NON-NLS-1$
    SPARK_FLUME_MRREQUIRED_MODULE_GROUP("SPARK-FLUME-LIB-MRREQUIRED-CDH_5_5"), //$NON-NLS-1$
    SQOOP_PARQUET_MODULE_GROUP("SQOOP-PARQUET-LIB-CDH_5_5"); //$NON-NLS-1$
