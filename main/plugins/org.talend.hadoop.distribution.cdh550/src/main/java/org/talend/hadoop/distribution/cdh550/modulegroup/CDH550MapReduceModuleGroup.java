...
public class CDH550MapReduceModuleGroup {
    ...
    private static final String MODULE_GROUP_NAME = "MAPREDUCE-LIB-CDH_5_5"; //$NON-NLS-1$

    private static final String HDFS_MODULE_GROUP_NAME = "HDFS-LIB-CDH_5_5"; //$NON-NLS-1$

    private static final String PARQUET_MODULE_GROUP_NAME = "MAPREDUCE-PARQUET-LIB-CDH_5_5"; //$NON-NLS-1$
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(PARQUET_MODULE_GROUP_NAME));
        return hs;
    }
