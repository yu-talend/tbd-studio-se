...
public class IBMS210SparkBatchParquetNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        DistributionModuleGroup dmg = new DistributionModuleGroup(
        		IBMS210Constant.SPARK_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new SparkBatchLinkedNodeCondition(
        				IBMS210Distribution.DISTRIBUTION_NAME, IBMS210Distribution.VERSION).getCondition());
        hs.add(dmg);
        return hs;
    }
}
