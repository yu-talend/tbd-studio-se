...
public class CDH5100SparkStreamingKafkaClientModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        DistributionModuleGroup dmgSpark16 = new DistributionModuleGroup(
                CDH5100Constant.SPARK_KAFKA_CLIENT_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new MultiComponentCondition(
        ...
        DistributionModuleGroup dmgSpark21 = new DistributionModuleGroup(
                CDH5100Constant.SPARK2_KAFKA_CLIENT_MRREQUIRED_MODULE_GROUP.getModuleName(), true, new MultiComponentCondition(
                        new SparkStreamingLinkedNodeCondition(distribution, version,
                                SparkStreamingConstant.KAFKA_SPARKCONFIGURATION_LINKEDPARAMETER).getCondition(),
