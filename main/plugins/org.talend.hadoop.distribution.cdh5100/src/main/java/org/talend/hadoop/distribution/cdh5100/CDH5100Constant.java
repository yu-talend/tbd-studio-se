...
public enum CDH5100Constant {
    ...
    SPARK_KUDU_MRREQUIRED_MODULE_GROUP("SPARK_KUDU_MRREQUIRED_MODULE_GROUP"), //$NON-NLS-1$
    SPARK2_KUDU_MRREQUIRED_MODULE_GROUP("SPARK2_KUDU_MRREQUIRED_MODULE_GROUP"), //$NON-NLS-1$
