...
public class CDH580PigOutputModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH5100Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false, hcatStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5100Constant.HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5100Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5100Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroStorerCondition));
        hs.add(new DistributionModuleGroup(CDH5100Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileStorerCondition));
