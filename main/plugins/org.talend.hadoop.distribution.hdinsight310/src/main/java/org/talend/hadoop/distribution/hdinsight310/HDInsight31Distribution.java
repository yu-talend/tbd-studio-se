...
public class HDInsight31Distribution extends AbstractDistribution implements MRComponent, PigComponent, HiveComponent,
        IMicrosoftHDInsightDistribution {

    public static final String VERSION = "MICROSOFT_HD_INSIGHT_3_1";

    public static final String VERSION_DISPLAY = "Microsoft HD Insight 3.1 - DEPRECATED";
