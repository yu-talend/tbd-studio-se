 ...
 */
public class HDP260HiveMetadataHelperTest extends AbstractVersionTest4HiveMetadataHelper {
    ...
    //@Test
    public void testHiveMode_HDP260_Server2WithStandalone() {
        if (notSupportForTOP()) {
    ...
    //@Test
    public void testHiveServer_HDP260_Sever2_Only() {
        if (notSupportForTOP()) {
